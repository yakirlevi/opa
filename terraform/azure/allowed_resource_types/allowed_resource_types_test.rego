...
test_validate_deny_message {
  result:= deny 
                with input as data.plan_mock
                with data.allowed_resource_types as ["azure_vm", "azure_date_lake_storage"] 
  expected_deny_message:= "Invalid resource type: '{\"azurerm_resource_group\", \"azurerm_storage_account\", \"azurerm_storage_container\"}'. The allowed Azure resource types are: {\"azure_date_lake_storage\", \"azure_vm\"}"
